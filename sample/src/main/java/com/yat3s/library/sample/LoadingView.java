...
public class LoadingView extends View {
    ...
    private void init() {
        ...
        for (int i = 1; i < ITEM_COUNT; i++) {
            ...
            circlePath.center = new float[]{(radius * 2 + ITEM_DIVIDER) * i, radius * (1f +
                    SCALE_RATE)};
     ...
     * @param maxDistance
     */
    private void metaball(Canvas canvas, int j, int i, float v, float handle_len_rate, float
            maxDistance) {
...
//        Log.d("Metaball", "center2:" + Arrays.toString(center2) + ",center1:" + Arrays.toString
// (center1));
...
//        Log.d("Metaball", "angle1:" + angle1 + ",angle2:" + angle2 + ",angle1a:" + angle1a + ",
// angle1b:" + angle1b + ",angle2a:" + angle2a + ",angle2b:" + angle2b);
...
//        Log.d("Metaball", "p1a:" + Arrays.toString(p1a) + ",p1b:" + Arrays.toString(p1b) + ",
// p2a:" + Arrays.toString(p2a) + ",p2b:" + Arrays.toString(p2b));
...
//        Log.d("Metaball", "sp1:" + Arrays.toString(sp1) + ",sp2:" + Arrays.toString(sp2) + ",
// sp3:" + Arrays.toString(sp3) + ",sp4:" + Arrays.toString(sp4));


        Path path1 = new Path();
        path1.moveTo(p1a[0], p1a[1]);
        path1.cubicTo(p1a[0] + sp1[0], p1a[1] + sp1[1], p2a[0] + sp2[0], p2a[1] + sp2[1], p2a[0],
                p2a[1]);
        path1.lineTo(p2b[0], p2b[1]);
        path1.cubicTo(p2b[0] + sp3[0], p2b[1] + sp3[1], p1b[0] + sp4[0], p1b[1] + sp4[1], p1b[0],
                p1b[1]);
...
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(resolveSizeAndState((int) (ITEM_COUNT * (radius * 2 + ITEM_DIVIDER))
                , widthMeasureSpec, 0),
